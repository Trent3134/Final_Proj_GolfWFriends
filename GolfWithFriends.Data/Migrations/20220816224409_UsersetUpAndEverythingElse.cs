...
{
    public partial class UsersetUpAndEverythingElse : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    GolferId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    FriendId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GolferFriends", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GolferFriends_AspNetUsers_FriendId",
                        column: x => x.FriendId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GolferFriends_AspNetUsers_GolferId",
                        column: x => x.GolferId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GolferFriends_FriendId",
                table: "GolferFriends",
                column: "FriendId");

            migrationBuilder.CreateIndex(
                name: "IX_GolferFriends_GolferId",
                table: "GolferFriends",
                column: "GolferId");
        }
